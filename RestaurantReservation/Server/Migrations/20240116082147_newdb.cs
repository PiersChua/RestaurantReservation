    ...
    public partial class newdb : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "900de75c-2b44-4069-8c0d-d7d3a7ae4ffb", 0, "9cd1a925-f766-4c89-971c-ff13a8305366", "admin@localhost.com", false, false, null, "ADMIN@LOCALHOST.COM", "ADMIN@LOCALHOST.COM", "AQAAAAIAAYagAAAAEGBkIwghlCtovXX2pPIh/TFe1aw3y/ZZDhSRNGVxg7MkPz1vHRLyWE+9UT3G4RUtmw==", null, false, "ccc1b0e3-89ae-41dd-a3d2-9956b2839522", false, "admin@localhost.com" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 123, "1234123412341234", null, new DateTime(2025, 1, 16, 16, 21, 47, 106, DateTimeKind.Local).AddTicks(9879), "Josh" },
                    { 2, 321, "1234123412341234", null, new DateTime(2025, 1, 16, 16, 21, 47, 106, DateTimeKind.Local).AddTicks(9891), "Liza" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "NY2024", "Celebrate the New Year with fantastic deals! Enjoy exclusive discounts on all reservations. Start 2024 in style with limited-time offers and extra savings just for you. Renew, refresh, and rejoice! Reserve now and make this year unforgettable. Cheers to a fantastic 2024!", 10.0, new DateTime(2024, 2, 16, 16, 21, 47, 107, DateTimeKind.Local).AddTicks(799), "NewYear", new DateTime(2024, 1, 16, 16, 21, 47, 107, DateTimeKind.Local).AddTicks(796) },
                    { 2, "CNY2024", "Celebrate the Lunar New Year at Bookbite! Reserve your table now for an exquisite culinary journey featuring luck-filled banquets and exclusive dining packages. Indulge in authentic flavors that capture the essence of the season. Make your celebrations memorable with us. Gong Xi Fa Cai!", 10.0, new DateTime(2024, 3, 16, 16, 21, 47, 107, DateTimeKind.Local).AddTicks(804), "ChineseNewYear", new DateTime(2024, 2, 16, 16, 21, 47, 107, DateTimeKind.Local).AddTicks(803) },
                    { 3, "LOVE2024", "Celebrate love at Bookbite! Book your romantic evening for an unforgettable Valentine's experience. Indulge in exquisite dining with our special menu, crafted to ignite the flames of love. Enjoy a romantic ambiance and impeccable service, setting the stage for a memorable evening. Delight in exclusive dishes designed to make hearts flutter. Love is in the air at Bookbite!", 10.0, new DateTime(2024, 4, 16, 16, 21, 47, 107, DateTimeKind.Local).AddTicks(806), "Valentine", new DateTime(2024, 3, 16, 16, 21, 47, 107, DateTimeKind.Local).AddTicks(805) }
                });
            ...
            migrationBuilder.InsertData(
                ...
                columns: new[] { "Id", "AddressId", "Category", "Cuisine", "CustomerId", "Description", "Email", "ImagePath", "Location", "MenuId", "OperatingHourId", "PhoneNumber", "RestaurantName", "SeatingCapacityId", "StaffId", "Status" },
                values: new object[,]
                {
                    { 1, null, "Hotpot", "Chinese", null, "good hotpot,must try!", "paradisehotpot@paradise.com", "/image", "East", null, null, 63864838, "Paradise Hotpot", null, null, "Active" },
                    { 2, null, "Hotpot", "Chinese", null, "good hotpot,must try!", "slfhotpot@slf.com", "/image", "East", null, null, 62601838, "Shi Li Fang Hotpot", null, null, "Active" },
                    { 3, null, "BBQ", "Korea", null, "good bbq,100% must try!", "ManNa@koreanBBQ.com", "/image", "East", null, null, 62601838, "ManNa Korean BBQ", null, null, "Active" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2024, 1, 16, 16, 21, 47, 106, DateTimeKind.Local).AddTicks(8976), 10.0, new DateTime(2024, 1, 16, 16, 21, 47, 106, DateTimeKind.Local).AddTicks(8975) },
                    { 2, new DateTime(2024, 1, 16, 16, 21, 47, 106, DateTimeKind.Local).AddTicks(8979), 10.0, new DateTime(2024, 1, 16, 16, 21, 47, 106, DateTimeKind.Local).AddTicks(8979) }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, null, new DateTime(2024, 1, 16, 16, 21, 47, 57, DateTimeKind.Local).AddTicks(8350), 2, null, "None", 1, 1, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 2, null, new DateTime(2024, 1, 16, 16, 21, 47, 57, DateTimeKind.Local).AddTicks(8366), 3, null, "None", 2, 2, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 3, null, new DateTime(2024, 1, 16, 16, 21, 47, 57, DateTimeKind.Local).AddTicks(8367), 4, null, "None", 1, 3, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 4, null, new DateTime(2024, 1, 16, 16, 21, 47, 57, DateTimeKind.Local).AddTicks(8369), 2, null, "None", 1, 5, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, null, new DateTime(2024, 1, 16, 16, 21, 47, 107, DateTimeKind.Local).AddTicks(968), "Hai di lao staff very attentive", 4, 1 },
                    { 2, null, new DateTime(2024, 1, 16, 16, 21, 47, 107, DateTimeKind.Local).AddTicks(970), "Good food", 4, 2 },
                    { 3, null, new DateTime(2024, 1, 16, 16, 21, 47, 107, DateTimeKind.Local).AddTicks(972), "Nice soup", 4, 3 },
                    { 4, null, new DateTime(2024, 1, 16, 16, 21, 47, 107, DateTimeKind.Local).AddTicks(973), "Cheap and affordable", 4, 4 },
                    { 5, null, new DateTime(2024, 1, 16, 16, 21, 47, 107, DateTimeKind.Local).AddTicks(974), "Great restaurant", 4, 5 },
                    { 6, null, new DateTime(2024, 1, 16, 16, 21, 47, 107, DateTimeKind.Local).AddTicks(976), "Excellent service and outstanding food!", 5, 1 },
                    { 7, null, new DateTime(2024, 1, 16, 16, 21, 47, 107, DateTimeKind.Local).AddTicks(977), "Good experience with room for improvement", 3, 1 },
                    { 8, null, new DateTime(2024, 1, 16, 16, 21, 47, 107, DateTimeKind.Local).AddTicks(978), "Disappointing experience. Not recommended.", 1, 2 },
                    { 9, null, new DateTime(2024, 1, 16, 16, 21, 47, 107, DateTimeKind.Local).AddTicks(980), "Amazing ambiance and top-notch cuisine!", 5, 2 },
                    { 10, null, new DateTime(2024, 1, 16, 16, 21, 47, 107, DateTimeKind.Local).AddTicks(981), "Satisfactory visit but lacks a wow factor.", 2, 3 },
                    { 11, null, new DateTime(2024, 1, 16, 16, 21, 47, 107, DateTimeKind.Local).AddTicks(983), "Unpleasant experience. Would not recommend", 1, 3 },
                    { 12, null, new DateTime(2024, 1, 16, 16, 21, 47, 107, DateTimeKind.Local).AddTicks(984), "Satisfactory visit but lacks a wow factor.", 1, 4 },
                    { 13, null, new DateTime(2024, 1, 16, 16, 21, 47, 107, DateTimeKind.Local).AddTicks(985), "Outstanding service and exquisite dishes!", 5, 4 },
                    { 14, null, new DateTime(2024, 1, 16, 16, 21, 47, 107, DateTimeKind.Local).AddTicks(986), "Poor service and disappointing menu", 1, 5 },
                    { 15, null, new DateTime(2024, 1, 16, 16, 21, 47, 107, DateTimeKind.Local).AddTicks(987), "Exceptional dining experience with impeccable service!", 5, 5 },
                    { 16, null, new DateTime(2024, 1, 16, 16, 21, 47, 107, DateTimeKind.Local).AddTicks(989), "Superb service and a menu that delights the taste buds!", 5, 6 },
                    { 17, null, new DateTime(2024, 1, 16, 16, 21, 47, 107, DateTimeKind.Local).AddTicks(990), "Adequate experience, but lacks a special touch", 3, 6 },
                    { 18, null, new DateTime(2024, 1, 16, 16, 21, 47, 107, DateTimeKind.Local).AddTicks(991), "Awful service and disappointing overall.", 1, 6 },
                    { 19, null, new DateTime(2024, 1, 16, 16, 21, 47, 107, DateTimeKind.Local).AddTicks(993), "Superb service and a menu that delights the taste buds!", 5, 7 },
                    { 20, null, new DateTime(2024, 1, 16, 16, 21, 47, 107, DateTimeKind.Local).AddTicks(994), "Adequate experience, but lacks a special touch", 3, 7 },
                    { 21, null, new DateTime(2024, 1, 16, 16, 21, 47, 107, DateTimeKind.Local).AddTicks(995), "Awful service and disappointing overall.", 1, 7 },
                    { 22, null, new DateTime(2024, 1, 16, 16, 21, 47, 107, DateTimeKind.Local).AddTicks(996), "Superb service and a menu that delights the taste buds!", 5, 8 },
                    { 23, null, new DateTime(2024, 1, 16, 16, 21, 47, 107, DateTimeKind.Local).AddTicks(997), "Adequate experience, but lacks a special touch", 3, 8 },
                    { 24, null, new DateTime(2024, 1, 16, 16, 21, 47, 107, DateTimeKind.Local).AddTicks(999), "Awful service and disappointing overall.", 1, 8 },
                    { 25, null, new DateTime(2024, 1, 16, 16, 21, 47, 107, DateTimeKind.Local).AddTicks(1000), "Superb service and a menu that delights the taste buds!", 5, 9 },
                    { 26, null, new DateTime(2024, 1, 16, 16, 21, 47, 107, DateTimeKind.Local).AddTicks(1001), "Adequate experience, but lacks a special touch", 3, 9 },
                    { 27, null, new DateTime(2024, 1, 16, 16, 21, 47, 107, DateTimeKind.Local).AddTicks(1003), "Awful service and disappointing overall.", 1, 9 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 15, new DateTime(2024, 1, 16, 16, 21, 47, 106, DateTimeKind.Local).AddTicks(8778), 1 },
                    { 2, 15, new DateTime(2024, 1, 16, 16, 21, 47, 106, DateTimeKind.Local).AddTicks(8791), 2 },
                    { 3, 15, new DateTime(2024, 1, 16, 16, 21, 47, 106, DateTimeKind.Local).AddTicks(8792), 3 },
                    { 4, 15, new DateTime(2024, 1, 16, 16, 21, 47, 106, DateTimeKind.Local).AddTicks(8794), 4 },
                    { 5, 15, new DateTime(2024, 1, 16, 16, 21, 47, 106, DateTimeKind.Local).AddTicks(8795), 5 }
                });
