    ...
    public partial class newdb : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "900de75c-2b44-4069-8c0d-d7d3a7ae4ffb", 0, "14a6f25e-6ef7-4a4e-bbad-0dc850f07634", "admin@localhost.com", false, false, null, "ADMIN@LOCALHOST.COM", "ADMIN@LOCALHOST.COM", "AQAAAAIAAYagAAAAEBKeAAGLI7ifTUMw5TsdoGx3ufeAM2hKZFw39nAeX1oLoxGlgQ08SiUclshfmlT5cQ==", null, false, "fa4a84bf-684a-4bd6-bb20-bcfdca4ff561", false, "admin@localhost.com" });

            migrationBuilder.InsertData(
                table: "PaymentMethods",
                columns: new[] { "Id", "CVV", "CardNumber", "CustomerId", "DateOfExpiry", "Name", "Username" },
                values: new object[,]
                {
                    { 1, 123, "1234123412341234", null, new DateTime(2025, 1, 25, 0, 49, 3, 875, DateTimeKind.Local).AddTicks(3538), "Josh", "admin@localhost.com" },
                    { 2, 321, "1234123412341234", null, new DateTime(2025, 1, 25, 0, 49, 3, 875, DateTimeKind.Local).AddTicks(3553), "Liza", "admin@localhost.com" }
                });

            migrationBuilder.InsertData(
                table: "Promotions",
                columns: new[] { "Id", "Code", "Description", "Discount", "EndDate", "ImagePath", "Name", "StartDate" },
                values: new object[,]
                {
                    { 1, "NY2024", "Celebrate the New Year with fantastic deals! Enjoy exclusive discounts on all reservations. Start 2024 in style with limited-time offers and extra savings just for you. Renew, refresh, and rejoice! Reserve now and make this year unforgettable. Cheers to a fantastic 2024!", 10.0, new DateTime(2024, 2, 25, 0, 49, 3, 875, DateTimeKind.Local).AddTicks(4501), "https://cdn.tatlerasia.com/tatlerasia/i/2022/12/28171650-andrew-jk-tan_cover_1500x1050.jpeg", "NewYear", new DateTime(2024, 1, 25, 0, 49, 3, 875, DateTimeKind.Local).AddTicks(4499) },
                    { 2, "CNY2024", "Celebrate the Lunar New Year at Bookbite! Reserve your table now for an exquisite culinary journey featuring luck-filled banquets and exclusive dining packages. Indulge in authentic flavors that capture the essence of the season. Make your celebrations memorable with us. Gong Xi Fa Cai!", 10.0, new DateTime(2024, 3, 25, 0, 49, 3, 875, DateTimeKind.Local).AddTicks(4508), "https://img.freepik.com/premium-vector/chinese-new-year-2024-with-cartoon-cute-dragon-zodiac-riding-oriental-cloud-year-dragon_438266-910.jpg", "ChineseNewYear", new DateTime(2024, 2, 25, 0, 49, 3, 875, DateTimeKind.Local).AddTicks(4507) },
                    { 3, "LOVE2024", "Celebrate love at Bookbite! Book your romantic evening for an unforgettable Valentine's experience. Indulge in exquisite dining with our special menu, crafted to ignite the flames of love. Enjoy a romantic ambiance and impeccable service, setting the stage for a memorable evening. Delight in exclusive dishes designed to make hearts flutter. Love is in the air at Bookbite!", 10.0, new DateTime(2024, 4, 25, 0, 49, 3, 875, DateTimeKind.Local).AddTicks(4511), "https://www.daysoftheyear.com/cdn-cgi/image/dpr=1%2Cf=auto%2Cfit=cover%2Cheight=650%2Cq=40%2Csharpen=1%2Cwidth=956/wp-content/uploads/valentines-day-concept-2021-12-14-20-37-41-utc-scaled.jpg", "Valentine", new DateTime(2024, 3, 25, 0, 49, 3, 875, DateTimeKind.Local).AddTicks(4510) }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2024, 1, 25, 0, 49, 3, 875, DateTimeKind.Local).AddTicks(2484), 10.0, new DateTime(2024, 1, 25, 0, 49, 3, 875, DateTimeKind.Local).AddTicks(2483) },
                    { 2, new DateTime(2024, 1, 25, 0, 49, 3, 875, DateTimeKind.Local).AddTicks(2486), 10.0, new DateTime(2024, 1, 25, 0, 49, 3, 875, DateTimeKind.Local).AddTicks(2485) }
                });
            ...
            migrationBuilder.InsertData(
                table: "Reservations",
                columns: new[] { "Id", "CustomerId", "Date", "Guest", "PromotionId", "Request", "ReservationStatusId", "RestaurantId", "Time", "Username" },
                values: new object[,]
                {
                    { 1, null, new DateTime(2024, 1, 25, 0, 49, 3, 826, DateTimeKind.Local).AddTicks(1111), 2, null, "None", 1, 1, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "admin@localhost.com" },
                    { 2, null, new DateTime(2024, 1, 25, 0, 49, 3, 826, DateTimeKind.Local).AddTicks(1127), 3, null, "None", 2, 2, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "admin@localhost.com" },
                    { 3, null, new DateTime(2024, 1, 25, 0, 49, 3, 826, DateTimeKind.Local).AddTicks(1129), 4, null, "None", 1, 3, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "admin@localhost.com" },
                    { 4, null, new DateTime(2024, 1, 25, 0, 49, 3, 826, DateTimeKind.Local).AddTicks(1131), 2, null, "None", 1, 5, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "admin@localhost.com" }
                });

            migrationBuilder.InsertData(
                table: "Reviews",
                columns: new[] { "Id", "CustomerId", "DateTime", "Description", "Rating", "RestaurantId", "Username" },
                values: new object[,]
                {
                    { 1, null, new DateTime(2024, 1, 25, 0, 49, 3, 875, DateTimeKind.Local).AddTicks(4687), "Hai di lao staff very attentive", 4, 1, "admin@localhost.com" },
                    { 2, null, new DateTime(2024, 1, 25, 0, 49, 3, 875, DateTimeKind.Local).AddTicks(4690), "Good food", 4, 2, "admin@localhost.com" },
                    { 3, null, new DateTime(2024, 1, 25, 0, 49, 3, 875, DateTimeKind.Local).AddTicks(4692), "Nice soup", 4, 3, "admin@localhost.com" },
                    { 4, null, new DateTime(2024, 1, 25, 0, 49, 3, 875, DateTimeKind.Local).AddTicks(4693), "Cheap and affordable", 4, 4, "admin@localhost.com" },
                    { 5, null, new DateTime(2024, 1, 25, 0, 49, 3, 875, DateTimeKind.Local).AddTicks(4694), "Great restaurant", 4, 5, "admin@localhost.com" },
                    { 6, null, new DateTime(2024, 1, 25, 0, 49, 3, 875, DateTimeKind.Local).AddTicks(4696), "Excellent service and outstanding food!", 5, 1, "admin@localhost.com" },
                    { 7, null, new DateTime(2024, 1, 25, 0, 49, 3, 875, DateTimeKind.Local).AddTicks(4697), "Good experience with room for improvement", 3, 1, "admin@localhost.com" },
                    { 8, null, new DateTime(2024, 1, 25, 0, 49, 3, 875, DateTimeKind.Local).AddTicks(4699), "Disappointing experience. Not recommended.", 1, 2, "admin@localhost.com" },
                    { 9, null, new DateTime(2024, 1, 25, 0, 49, 3, 875, DateTimeKind.Local).AddTicks(4700), "Amazing ambiance and top-notch cuisine!", 5, 2, "admin@localhost.com" },
                    { 10, null, new DateTime(2024, 1, 25, 0, 49, 3, 875, DateTimeKind.Local).AddTicks(4701), "Satisfactory visit but lacks a wow factor.", 2, 3, "admin@localhost.com" },
                    { 11, null, new DateTime(2024, 1, 25, 0, 49, 3, 875, DateTimeKind.Local).AddTicks(4703), "Unpleasant experience. Would not recommend", 1, 3, "admin@localhost.com" },
                    { 12, null, new DateTime(2024, 1, 25, 0, 49, 3, 875, DateTimeKind.Local).AddTicks(4704), "Satisfactory visit but lacks a wow factor.", 1, 4, "admin@localhost.com" },
                    { 13, null, new DateTime(2024, 1, 25, 0, 49, 3, 875, DateTimeKind.Local).AddTicks(4705), "Outstanding service and exquisite dishes!", 5, 4, "admin@localhost.com" },
                    { 14, null, new DateTime(2024, 1, 25, 0, 49, 3, 875, DateTimeKind.Local).AddTicks(4707), "Poor service and disappointing menu", 1, 5, "admin@localhost.com" },
                    { 15, null, new DateTime(2024, 1, 25, 0, 49, 3, 875, DateTimeKind.Local).AddTicks(4708), "Exceptional dining experience with impeccable service!", 5, 5, "admin@localhost.com" },
                    { 16, null, new DateTime(2024, 1, 25, 0, 49, 3, 875, DateTimeKind.Local).AddTicks(4710), "Superb service and a menu that delights the taste buds!", 5, 6, "admin@localhost.com" },
                    { 17, null, new DateTime(2024, 1, 25, 0, 49, 3, 875, DateTimeKind.Local).AddTicks(4711), "Adequate experience, but lacks a special touch", 3, 6, "admin@localhost.com" },
                    { 18, null, new DateTime(2024, 1, 25, 0, 49, 3, 875, DateTimeKind.Local).AddTicks(4712), "Awful service and disappointing overall.", 1, 6, "admin@localhost.com" },
                    { 19, null, new DateTime(2024, 1, 25, 0, 49, 3, 875, DateTimeKind.Local).AddTicks(4713), "Superb service and a menu that delights the taste buds!", 5, 7, "admin@localhost.com" },
                    { 20, null, new DateTime(2024, 1, 25, 0, 49, 3, 875, DateTimeKind.Local).AddTicks(4715), "Adequate experience, but lacks a special touch", 3, 7, "admin@localhost.com" },
                    { 21, null, new DateTime(2024, 1, 25, 0, 49, 3, 875, DateTimeKind.Local).AddTicks(4716), "Awful service and disappointing overall.", 1, 7, "admin@localhost.com" },
                    { 22, null, new DateTime(2024, 1, 25, 0, 49, 3, 875, DateTimeKind.Local).AddTicks(4718), "Superb service and a menu that delights the taste buds!", 5, 8, "admin@localhost.com" },
                    { 23, null, new DateTime(2024, 1, 25, 0, 49, 3, 875, DateTimeKind.Local).AddTicks(4719), "Adequate experience, but lacks a special touch", 3, 8, "admin@localhost.com" },
                    { 24, null, new DateTime(2024, 1, 25, 0, 49, 3, 875, DateTimeKind.Local).AddTicks(4720), "Awful service and disappointing overall.", 1, 8, "admin@localhost.com" },
                    { 25, null, new DateTime(2024, 1, 25, 0, 49, 3, 875, DateTimeKind.Local).AddTicks(4722), "Superb service and a menu that delights the taste buds!", 5, 9, "admin@localhost.com" },
                    { 26, null, new DateTime(2024, 1, 25, 0, 49, 3, 875, DateTimeKind.Local).AddTicks(4723), "Adequate experience, but lacks a special touch", 3, 9, "admin@localhost.com" },
                    { 27, null, new DateTime(2024, 1, 25, 0, 49, 3, 875, DateTimeKind.Local).AddTicks(4724), "Awful service and disappointing overall.", 1, 9, "admin@localhost.com" },
                    { 28, null, new DateTime(2024, 1, 25, 0, 49, 3, 875, DateTimeKind.Local).AddTicks(4725), "I recently had the pleasure of dining at Haidilao, and I must say it was an unforgettable experience that tantalized my taste buds and left me craving more. From the moment I stepped into the restaurant, the warm and inviting atmosphere set the stage for a culinary adventure like no other", 5, 1, "admin@localhost.com" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 15, new DateTime(2024, 1, 25, 0, 49, 3, 875, DateTimeKind.Local).AddTicks(2250), 1 },
                    { 2, 15, new DateTime(2024, 1, 25, 0, 49, 3, 875, DateTimeKind.Local).AddTicks(2269), 2 },
                    { 3, 15, new DateTime(2024, 1, 25, 0, 49, 3, 875, DateTimeKind.Local).AddTicks(2270), 3 },
                    { 4, 15, new DateTime(2024, 1, 25, 0, 49, 3, 875, DateTimeKind.Local).AddTicks(2272), 4 },
                    { 5, 15, new DateTime(2024, 1, 25, 0, 49, 3, 875, DateTimeKind.Local).AddTicks(2273), 5 }
                });
